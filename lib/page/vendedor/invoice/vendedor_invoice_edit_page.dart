...
class VendedorInvoiceEditPage extends StatefulWidget {
  ...
  const VendedorInvoiceEditPage({super.key, required this.invoice});

  @override
  State<VendedorInvoiceEditPage> createState() => _VendedorInvoiceEditPageState();
}

class _VendedorInvoiceEditPageState extends State<VendedorInvoiceEditPage> {
