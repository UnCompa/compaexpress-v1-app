...
import 'package:compaexpress/models/Order.dart';
...
class VendedorOrderListScreen extends StatefulWidget {
  ...
  @override
  State<VendedorOrderListScreen> createState() =>
      _VendedorOrderListScreenState();
}

class _VendedorOrderListScreenState extends State<VendedorOrderListScreen> {
  List<Order> _orders = [];
    ...
    try {
      ...
      final request = ModelQueries.list(
        ...
        where:
            ...
            Order.NEGOCIOID.eq(negocio.negocioId) &
            Order.SELLERID.eq(negocio.userId),
      );
